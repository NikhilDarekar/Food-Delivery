...
import StoreGoogle from '../../assets/shop/appstore.png'
        ...
        <Container>
          <Row className='align-items-center'>
            <Col lg={6} className='text-center text-lg-start mb-5 mb-lg-0'>
              ...
              <h2>Save upto 20%</h2>
              <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Natus, ipsum?</p>
              <Link to='/'>  
                  <img src={StoreIOS} alt='IOS' className='store img-fluid me-3 '></img>
              </Link>
              <Link to='/'>  
                  <img src={StoreGoogle} alt='Android' className='store img-fluid me-3 '></img>
              </Link>
            </Col>
            <Col lg={6}>
              <Link to='/'>
                <img src={DownloadImage} alt='Download' className='img-fluid'></img>
              </Link>
